...
**เวอร์ชันปัจจุบันของระบบ:** v0.7.27  
...
### 8.1 สถานภาพปัจจุบัน (ปัจจุบัน = v0.7.27)
...
| v0.7.27 | **แยกสมุด Google Sheets ให้ถูกส่วน (ตามผู้ใช้ร้องขอ): ตรวจสภาพ → สมุดตรวจสภาพเท่านั้น, ไมล์เข้า-ออก → สมุดบันทึกการเข้า-ออกรถยนต์เท่านั้น — ต้อง Redeploy GAS!**
  ...
  - การตรวจ: `node --check` ผ่าน 9/9 |
| v0.7.28 วางแผน | ตัวเลือกถัดไป: ส่งสรุปรายวัน/สัปดาห์, ปรับแต่ง HTML อีเมล, แจ้งเตือนจุดชำรุดวิกฤตถึงช่าง |
