...
**เวอร์ชันปัจจุบันของระบบ:** v0.7.26  
...
### 8.1 สถานภาพปัจจุบัน (ปัจจุบัน = v0.7.26)
...
| v0.7.26 | **แก้บั๊ก "อีเมลแจ้งเตือน PM/ภาษี ไม่ยิงถึงหัวหน้า+ช่าง" (ตาม bug report ผู้ใช้):**
  ...
  - การตรวจ: `node --check` ผ่าน 9/9 |
| v0.7.27 วางแผน | ตัวเลือกถัดไป: ส่งสรุปรายวัน/สัปดาห์, ปรับแต่ง HTML อีเมล, แจ้งเตือนจุดชำรุดวิกฤตถึงช่าง |
