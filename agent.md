...
**เวอร์ชันปัจจุบันของระบบ:** v0.7.25  
...
### 8.1 สถานภาพปัจจุบัน (ปัจจุบัน = v0.7.25)
...
| v0.7.26 วางแผน | ตัวเลือกถัดไป: ส่งสรุปรายวัน/สัปดาห์, ปรับแต่ง HTML อีเมล, แจ้งเตือนจุดชำรุดวิกฤตถึงช่าง |
